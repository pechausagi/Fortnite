...
<body>
  ...
  　</div>
    ...
    <ul class="participants" id="participants-list">
      ...
      <li><label><input type="checkbox" value="なっちゃん">なっちゃん</label></li>
      <li><label><input type="checkbox" value="うど">うど</label></li>
      <li><label><input type="checkbox" value="ともみ">ともみ</label></li>
